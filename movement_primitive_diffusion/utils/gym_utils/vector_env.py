"""Copied from https://github.com/Farama-Foundation/Gymnasium/tree/main/gymnasium/vector"""
"""No adaptions yet"""
        ...
        *,
        ...
        Example:
            ...
            (array([[ 0.0273956 , -0.00611216,  0.03585979,  0.0197368 ],
                  ...
                  dtype=float32), {})
        """
        self.reset_async(seed=seed, options=options, per_env_options=per_env_options)
        return self.reset_wait(seed=seed, options=options, per_env_options=per_env_options)
